...
module MenuLuna
  module SkillMenu
    ...
    # -----------------------------------------------------------------
    # Modify the window where the current actor is displayed.
    # -----------------------------------------------------------------
    CURRENT_ACTOR_WINDOW = {
        ...
        # -----------------------------------------------------------------
        :type_2     =>  {
            :picture  =>  "BattleHUD", # Graphics/System
            :opacity  =>  255,        # Change the transparency of the window.
            # 0 = Transparent, 255 = Solid
            :offset_x =>  0,
            :offset_y =>  0,
        },
    } # End CURRENT_ACTOR_WINDOW.

    # -----------------------------------------------------------------
    # Modify how the current actor is displayed.
    # -----------------------------------------------------------------
