...
module MenuLuna
  module MainMenu
    # -----------------------------------------------------------------
    # The Status Window is the window that is under all of the other menus.
    # -----------------------------------------------------------------
    STATUS_WINDOW = {
        # -----------------------------------------------------------------
    ...
    # If you want stronger control, use the CP Menu Command add-on.
    # -----------------------------------------------------------------
    WINDOW_COMMANDS = {
        # -----------------------------------------------------------------
        # :x refers to the horizontal axis. Based on the Cartesian Plane.
    ...
    # -----------------------------------------------------------------
    # This section allows you to add a Playtime display to your windows.
    # -----------------------------------------------------------------
    #--- START 2013.09.02
    PLAYTIME_SPRITE = {
        :enable   =>  false, # Enable Playtime Display?
        :width    =>  120,   # Width of the Playtime window.
        :height   =>  24,    # Height of the Playtime window.
        # -----------------------------------------------------------------
        # :x refers to the horizontal axis. Based on the Cartesian Plane.
        # Negative values (e.g. -1) mean they would move to the left, while
        # Positive values mean they would move to the right.
